...
static AddIn xai_modf(
	...
	.Documentation(LR"(
        The _modf functions return a value that is the integer part of the number and another value that is the fractional part of the number. There is no error return.
    )")
);
double WINAPI
*xll_modf(double x)
