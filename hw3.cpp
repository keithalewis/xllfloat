...
static AddIn xai_udf(
	...
	.Uncalced() // <-- This needs to be added.
	.Category(L"XLL")
...
static AddIn xai_false_positive(
	Function(XLL_FP, L"?xll_false_positive", L"FALSE.POSITIVE")
	.Arg(XLL_HANDLE, L"f", L"is the function.")
	.Arg(XLL_DOUBLE, L"x0", L"is the lower bracket.")
	.Arg(XLL_DOUBLE, L"x1", L"is the upper bracket.")
	.Category(L"ROOT1D")
...
_FP12* WINAPI xll_false_positive(HANDLEX f, double x0, double x1)
{
#pragma XLLEXPORT
	static xll::FP12 result(1, 2); // 1 x 2 array of doubles
